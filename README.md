...
The syntax and semantics of From Do language is still evolving. There is no formal specification yet. However, the sub-grammars of parsing/foramtting the date and time are relatively stable. The reference for the "cur" module, which is for parsing/formatting date and time strings, is [here](from-do-cur/src/cur/Grammar.md). The refernece for the "recur" module, which is for parsing/formatting recurring patterns, is [here](from-do-cur/src/recur/Grammar.md).
